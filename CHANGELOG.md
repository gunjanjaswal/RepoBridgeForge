...
All notable changes to Repo Bridge Forge are documented here.
...
- Replaced the bundled Parsedown library with a small built-in Markdown converter, removing the only third-party dependency. Raw HTML in synced files is escaped.
